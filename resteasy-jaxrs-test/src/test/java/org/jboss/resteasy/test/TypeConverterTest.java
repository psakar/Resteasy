...
public class TypeConverterTest
{
   ...
   {
      assertEquals((int)11, TypeConverter.getType(int.class, "11"), 0.0);
   ...
   {
      assertEquals((double)20.15d, TypeConverter.getType(double.class, "20.15"), 0.0);
   ...
   {
      assertEquals((float)23.44f, TypeConverter.getType(float.class, "23.44"), 0.0);
   ...
   {
      assertEquals((long)23, TypeConverter.getType(long.class, "23"), 0.0);
